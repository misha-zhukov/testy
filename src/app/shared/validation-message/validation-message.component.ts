...
@Component({
  ...
  template: `
    ...
    <p class="caption status-danger" *ngIf="showPattern">
      Incorrect {{ label }}
    </p>
    <p class="caption status-danger" *ngIf="showRequired">
      {{ label }} is required
    </p>
    <p class="caption status-danger" *ngIf="showMin">
      Min value of {{ label }} is {{ min }}
    </p>
    <p class="caption status-danger" *ngIf="showMax">
